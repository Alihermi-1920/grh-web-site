...
const DashboardHome = ({
  ...
  // Create department labels from the departments data in Dashboard.js
  const departmentLabels = ["RH", "IT", "Finance", "Marketing"]; // This should match the departments array in Dashboard.js
