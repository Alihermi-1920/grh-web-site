// src/pages/ChefAttendanceCalendar.js
  ...
  const fetchAttendance = () => {
    ...
    fetch("http://localhost:5000/api/presence")
      ...
      .then((data) => {
        ...
        setLoading(false);
        calculateDailyStats(selectedDate, filteredRecords);
      })
      .catch((err) => {
    ...
    <Box sx={{ p: 2 }}>
      ...
      <Box sx={{ mb: 4, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Typography variant="h5" sx={{ fontWeight: 'bold' }}>
          Calendrier de présence de mon équipe
        </Typography>
...
export default ChefAttendanceCalendar;
